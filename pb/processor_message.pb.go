...
var file_proto_processor_message_proto_rawDesc = []byte{
	...
	0x04, 0x6d, 0x61, 0x69, 0x6e, 0x1a, 0x1a, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x65, 0x6d,
	...
	0x75, 0x73, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x6d, 0x61,
	0x69, 0x6e, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0xa1,
	...
	0x41, 0x74, 0x22, 0x38, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4c, 0x69, 0x73,
	0x74, 0x12, 0x29, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x18, 0x01, 0x20,
	...
	0x72, 0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x6d, 0x61, 0x78, 0x5f,
	0x67, 0x68, 0x7a, 0x18, 0x05, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x6d, 0x61, 0x78, 0x47, 0x68,
	0x7a, 0x12, 0x17, 0x0a, 0x07, 0x6d, 0x69, 0x6e, 0x5f, 0x67, 0x68, 0x7a, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x01, 0x52, 0x06, 0x6d, 0x69, 0x6e, 0x47, 0x68, 0x7a, 0x22, 0x87, 0x01, 0x0a, 0x03, 0x47,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x6d, 0x61, 0x78, 0x47, 0x68, 0x7a, 0x12, 0x24,
	0x0a, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c,
	0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65,
	0x6d, 0x6f, 0x72, 0x79, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_processor_message_proto_goTypes = []interface{}{
	...
	(*UserList)(nil),    // 1: main.UserList
	(*Product)(nil),     // 2: main.Product
	(*ProductList)(nil), // 3: main.ProductList
	(*CPU)(nil),         // 4: main.CPU
	(*GPU)(nil),         // 5: main.GPU
	(*Memory)(nil),      // 6: main.Memory
}
var file_proto_processor_message_proto_depIdxs = []int32{
	0, // 0: main.UserList.users:type_name -> main.User
	2, // 1: main.ProductList.products:type_name -> main.Product
	6, // 2: main.GPU.memory:type_name -> main.Memory
...
func file_proto_processor_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_processor_message_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_processor_message_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_processor_message_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_processor_message_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CPU); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_processor_message_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GPU); i {
			case 0:
				return &v.state
			case 1:
